...
-- 刷新参赛记录物化视图
\echo 'Refreshing mv_g1g2_horse_records...'
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_g1g2_horse_records;

-- 刷新马匹对连线物化视图
\echo 'Refreshing mv_g1g2_horse_pairs...'
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_g1g2_horse_pairs;
